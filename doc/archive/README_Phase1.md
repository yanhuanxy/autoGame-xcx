> ⚠️ **历史文档，已过时**
>
> 本文件对应早期 Phase 1 开发计划，描述的能力远低于项目当前实际能力。
> 项目当前为**本地执行引擎 + MCP 服务端**（远程驱动 ilink 与 LLM 编排已迁出至 [wechat-ilink-bot](../../../wechat-ilink-bot)）。
> 当前状态请见项目根 `README.md` 与 `doc/architecture/overview.md`。
> 保留仅作历史追溯用，不再维护。
